        ...
        switch (language) {
            case ENGLISH:
                return "<html><body>" +
                        ...
                        "<a href=\"" + appUrl + "/api/security/confirm-email/" + emailConfirmationToken + "\">Activate the account</a>" +
                        "</body></html>";
            case RUSSIAN:
                return "<html><body>" +
                        "<style>" +
                        ...
                        "<a href=\"" + appUrl + "/api/security/confirm-email/" + emailConfirmationToken + "\">Активировать аккаунт</a>" +
                        "</body></html>";
            default:
        ...
        switch (language) {
            case ENGLISH:
                return "Welcome to HR-paradise!\n" +
                        ...
                        appUrl + "/api/security/confirm-email/" + emailConfirmationToken;
            case RUSSIAN:
